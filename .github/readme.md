...
---
## Q&A
Why isn't this completely filtering all ads?
- Some domains download the advertisements to their own application and serve them using their own domain; these are more difficult to block because you would have to block the entire domain to avoid seeing the adverts.
...
- There are no special requirements for submitting your list(s) to the repo, however we do urge that they be of high quality and updated on a regular basis.
...
![image](https://raw.githubusercontent.com/complexorganizations/content-blocker/main/assets/content-blocker.png)
